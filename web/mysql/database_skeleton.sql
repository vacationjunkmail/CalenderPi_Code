...
--
-- Current Database: `auth_users`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `auth_users` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
--
-- Dumping routines for database 'auth_users'
--
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `dinner` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
--
-- Table structure for table `video_game_and_characters`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `video_game_and_characters` (
  `video_game_id` smallint(3) unsigned DEFAULT NULL,
  `character_id` smallint(3) unsigned DEFAULT NULL
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `video_games` (
  ...
  `small_image` varchar(70) DEFAULT NULL,
  `large_image` varchar(70) DEFAULT NULL,
...
--
-- Current Database: `pythonscripts`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `pythonscripts` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
--
-- Dumping routines for database 'pythonscripts'
--

--
-- Current Database: `site_info`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `site_info` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
--
-- Dumping routines for database 'site_info'
--
